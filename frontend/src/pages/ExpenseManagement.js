...
import { PlusCircle, Trash2, PencilLine, Wallet, PiggyBank } from 'lucide-react';
    ...
    <div className="container py-4">
      <div className="d-flex justify-content-center mb-4">
        <div className="btn-group">
          <button
            className={`btn ${activeSection === 'expense' ? 'btn-primary' : 'btn-outline-primary'}`}
          ...
          <button
            className={`btn ${activeSection === 'budget' ? 'btn-primary' : 'btn-outline-primary'}`}
      ...
      {activeSection === 'expense' && (
        <div>
          ...
          {/* Bootstrap Modal */}
          <div className={`modal ${showExpenseModal ? 'show d-block' : ''}`} tabIndex="-1">
